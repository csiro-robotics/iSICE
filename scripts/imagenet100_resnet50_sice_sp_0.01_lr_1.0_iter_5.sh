...
modeldir=Results/deepSICE-$benchmark-$arch-$image_representation-$description-lr$lr-bs$batchsize-sparsity$sparsity-iterations$iterations-sicelr-$sicelr-448
if [ ! -d  "Results" ]; then
