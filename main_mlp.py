...
def main():
    ...
    if args.representation == 'GAvP':
        representation = {'function':GAvP,
                          'input_dim':2048}
    elif args.representation == 'GAvP_CONVNEXT':
        representation = {'function':GAvP_CONVNEXT,
                          'input_dim':2048,
                          'dimension_reduction':256}
    elif args.representation == 'GAvP_SWIN':
        representation = {'function':GAvP_SWIN,
                          'input_dim':2048,
                          'dimension_reduction':256}
    ...
    elif args.representation == 'MPNCOV_CONVNEXT':
        representation = {'function':MPNCOV_CONVNEXT,
                          'iterNum':5,
                          'is_sqrt':True,
                          'is_vec':True,
                          'input_dim':2048,
                          'dimension_reduction':256}
    elif args.representation == 'MPNCOV_SWIN':
        representation = {'function':MPNCOV_SWIN,
                          'iterNum':5,
                          'is_sqrt':True,
                          'is_vec':True,
                          'input_dim':2048,
                          'dimension_reduction':256}
    elif args.representation == 'MPNCOV_VGG':
        representation = {'function':MPNCOV_VGG,
                          'iterNum':5,
                          'is_sqrt':True,
                          'is_vec':True,
                          'input_dim':2048,
                          'dimension_reduction':256}
    elif args.representation == 'INV_NR':
        representation = {'function':INV_NR,
                          'iterNum':20,
                          'is_sqrt':True,
                          'is_vec':True,
                          'input_dim':2048,
                          'dimension_reduction':256}
    elif args.representation == 'INV_MPNCOV':
        representation = {'function':INV_MPNCOV,
                          'iterNum':7,
                          'is_sqrt':True,
                          'is_vec':True,
                          'input_dim':2048,
                          'dimension_reduction':256}
    elif args.representation == 'INV_MPNCOV_CONVNEXT':
        representation = {'function':INV_MPNCOV_CONVNEXT,
                          'iterNum':7,
                          'is_sqrt':True,
                          'is_vec':True,
                          'input_dim':2048,
                          'dimension_reduction':256}
    elif args.representation == 'INV_MPNCOV_SWIN':
        representation = {'function':INV_MPNCOV_SWIN,
                          'iterNum':7,
                          'is_sqrt':True,
                          'is_vec':True,
                          'input_dim':2048,
                          'dimension_reduction':256}
    elif args.representation == 'SICE_OBJ_STOP':
        representation = {'function':SICE_OBJ_STOP,
    ...
    elif args.representation == 'SICE_CONVNEXT':
        representation = {'function':SICE_CONVNEXT,
                          'iterNum':args.iterations,
                          'is_sqrt':True,
                          'is_vec':True,
                          'input_dim':2048,
                          ...
                          'sparsity_val':args.sparsity,
                          'sice_lrate':args.sicelr}
    elif args.representation == 'SICE_SWIN':
        representation = {'function':SICE_SWIN,
                          'iterNum':args.iterations,
                          'is_sqrt':True,
                          'is_vec':True,
                          'input_dim':2048,
                          ...
                          'sparsity_val':args.sparsity,
                          'sice_lrate':args.sicelr}
    elif args.representation == 'SICE_NR':
        representation = {'function':SICE_NR,
                          'iterNum':args.iterations,
                          'is_sqrt':True,
                          'is_vec':True,
                          'input_dim':2048,
                          ...
                          'sparsity_val':args.sparsity,
                          'sice_lrate':args.sicelr}
    elif args.representation == 'SICE_MLP':
        representation = {'function':SICE_MLP,
                          'iterNum':args.iterations,
                          'is_sqrt':True,
                          'is_vec':True,
                          'input_dim':2048,
                          ...
                          'sparsity_val':args.sparsity,
                          'sice_lrate':args.sicelr}
    elif args.representation == 'SICE_MLP_RES':
        representation = {'function':SICE_MLP_RES,
                          'iterNum':args.iterations,
                          'is_sqrt':True,
                          'is_vec':True,
                          'input_dim':2048,
...
def adaptive_sigmoid(x, offset, beta, max_range):
    #x = (x-torch.min(x))/(torch.max(x)-torch.min(x))
    #x = x.sum()
    return (max_range/(1+torch.exp(-beta*(x-offset))))
...
def train(train_loader, model, criterion, optimizer, epoch):
    ...
    for i, (input, target) in enumerate(train_loader):
        ...
        mlp_sp = - torch.log(model.representation.sice_sparsity)
        mlp_lr = - torch.log(model.representation.sice_lr)

        log_loss = mlp_sp+mlp_lr
        
        loss = loss + args.beta*log_loss
        print("LR:", model.representation.sice_lr.item(), " Sparsity:", model.representation.sice_sparsity.item())
